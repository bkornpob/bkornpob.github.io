(() => {
  ...
  const PLACEHOLDER_MODULES = [
    ...
    { id:'module-cooking-club', title:'zaddy-cooking-club', msg1:'ZADDY · cooking club', msg2:'the kitchen is open. the recipes are wild.', desc:'http-rabbit-hole cooking manual with a frontgate find-ZADDY game and a morning-cartoon landing. flip the right card and the rabbit hole opens.', attr2:'<a href="https://bkornpob.github.io/ZADDY-cooking-club/" target="_blank" style="color:var(--accent);text-decoration:none;">bkornpob.github.io/ZADDY-cooking-club</a>', attr3:'<a href="https://github.com/bkornpob/ZADDY-cooking-club" target="_blank" style="color:var(--accent);text-decoration:none;">github.com/bkornpob/ZADDY-cooking-club</a>', icon:'./images/cover-image-zaddy-cooking-club.webp', url:'https://bkornpob.github.io/ZADDY-cooking-club/', emoji:'./images/cover-image-zaddy-cooking-club.webp', emojiSize:'60px', emojiUrl:'https://bkornpob.github.io/ZADDY-cooking-club/' }
  ];
