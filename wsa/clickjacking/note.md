...
# 2 ## What is clickjacking? - Continued
...
# 3 ## How to construct a basic clickjacking attack
...
# 4 ## How to construct a basic clickjacking attack - Continued
...
# 5 ## Lab: Basic clickjacking with CSRF token protection
...
# 7 ## Clickjacking with prefilled form input
...
# 8 ## Lab: Clickjacking with form input data prefilled from a URL parameter
...
[paylad](./labs/lab2-payload.md)

---

# 9 ## Frame busting scripts
...
# 10 ## Frame busting scripts - Continued
...
# 11 ## Lab: Clickjacking with a frame buster script
...
# 12 ## Combining clickjacking with a DOM XSS attack
...
# 13 ## Lab: Exploiting clickjacking vulnerability to trigger DOM-based XSS
...
[payload](./labs/labXSS-payload.md)

---

# 14 ## Multistep clickjacking
...
[payload](./labs/lab-multiclick.md)

---

# 16 ## How to prevent clickjacking attacks
...
# 19 ## Content Security Policy (CSP) - Continued
