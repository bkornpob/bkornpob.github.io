...
# 4 ## SSRF attacks against the server
...
# 5 ## SSRF attacks against the server - Continued
...
# 6 ## Lab: Basic SSRF against the local server
...
# 7 ## SSRF attacks against other back-end systems
...
# 9 ## Circumventing common SSRF defenses
...
# 10 ## SSRF with blacklist-based input filters
...
# 11 ## Lab: SSRF with blacklist-based input filter
...
[lab 11 ssrf with input filter](./labs/lab11.md)

---

# 12 ## SSRF with whitelist-based input filters
...
# 13 ## Bypassing SSRF filters via open redirection
...
# 14 ## Lab: SSRF with filter bypass via open redirection vulnerability
...
# 16 ## What is the impact of blind SSRF vulnerabilities?
...
# 17 ## How to find and exploit blind SSRF vulnerabilities
...
# 18 ## How to find and exploit blind SSRF vulnerabilities - Continued
...
# 19 ## Lab: Blind SSRF with out-of-band detection
...
# 20 ## Finding hidden attack surface for SSRF vulnerabilities
...
# 23 ## SSRF via the Referer header
